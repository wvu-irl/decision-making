...
plt.legend(["aogs_c", "aogs_o", "ucb"])
# ax.axis('scaled')
# plt.autoscale(enable=False)
# cb = plt.colorbar()
# plt.legend()

plt.savefig(fp + "figs/avg_reward.eps", format="eps", bbox_inches="tight", pad_inches=0)
plt.savefig(fp + "figs/avg_reward.png", format="png", bbox_inches="tight", pad_inches=0.05)
# cb.remove()
